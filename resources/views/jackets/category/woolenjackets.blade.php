            ...
            <section class="banner-area organic-breadcrumb" id="products">
                <div class="container">
                    <div class="breadcrumb-banner d-flex flex-wrap align-items-center">
                        <div class="col-first">
                            <h1>Woolen Jackets</h1>
                             <nav class="d-flex align-items-center justify-content-start">
                                <a href={{url('/')}}>Home<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                <a href={{url('jackets')}}>Jackets<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                <a href={{url('woolenjackets')}}>Woolen Jackets</a>
                            </nav>
                        </div>
                    </div>
                </div>
    ...
    <!-- Start Filter Bar -->
                    ...
                    <div class="container">
                          ...
                          <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li><a href="{{url('leatherjackets')}}">Leather Jackets</a></li>
                                <li><a href="{{url('blazers')}}">Blazers</a></li>
                                <li><a href="{{url('hoodies')}}">Hoodies</a></li>
                                <li><a href="{{url('woolenjackets')}}">Woolen Jackets</a></li>
                            </ul>
                          </div>                        
                    </div>
                </nav>
