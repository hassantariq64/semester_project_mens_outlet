                        ...
                        <div class="col-first">
                            <h1>Reading Glasses</h1>
                             <nav class="d-flex align-items-center justify-content-start">
                                ...
                                <a href={{url('shades')}}>Shades<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                <a href={{url('readingglasses')}}>Reading Glasses</a>
                    ...
                    <div class="container">
                          ...
                          <div class="collapse navbar-collapse justify-content-end align-items-center" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li><a href="{{url('readingglasses')}}">Reading Glasses</a></li>
